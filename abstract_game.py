...
class GallowsGame(AbstractGame):
    ...
    word_base = ['слово', 'виселица', 'кинотеатр', 'фристайл', 'трамплин',
    'зимбабве', 'бельгия', 'сборник', 'интернет', 'арамис', 'диалог', 'реестр', 'молекула', 'караоке', 'практикум',
                 'сакура', 'мангал', 'поборы', 'услуга', 'жаворонок', 'диатез', 'великан', 'атлетика', 'провидец',
                 'гибрид', 'кактус', 'одеколон', 'нунчаки', 'эверест', 'компресс', 'каракули', 'лабрадор', 'бензовоз',
    'раскол', 'железо', 'путник', 'реферат', 'конспект', 'афина', 'айболит', 'каникулы', 'мустанг', 'лыжники',
                 'бандана', 'теист', 'мазурка', 'архимед', 'примат', 'заведение', 'предел', 'астероид', 'должность',
    'мистика', 'домофон', 'натура', 'молокосос', 'чеканка', 'инженер', 'зубоскал', 'квартал', 'колготки', 'самолё',
                 'декольте', 'каторга', 'ракурс', 'ранение', 'гусар', 'мародёр', 'валентин', 'тезис', 'подлость',
                 'сатана', 'карате', 'засада', 'горшок', 'городок', 'интрига', 'домино', 'знакомство', 'пограничник',
                 'вектор', 'самовар', 'лепесток', 'отвёртка', 'рассвет', 'номерок', 'татами', 'интерес', 'акционер',
                 'паспорт', 'алхимик', 'профессор', 'золото', 'левиафан', 'летопись', 'директор', 'ветеран']
